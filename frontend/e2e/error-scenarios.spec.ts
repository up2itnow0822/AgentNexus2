...
test.describe('Error Handling', () => {
  ...
  test('should display error message for invalid agent ID', async ({ page }) => {
    ...
    const hasError = await page.locator('text=/not found|404|error|doesn\'t exist/i').isVisible({ timeout: 5000 }).catch(() => false);
  ...
  test('should show loading state during slow requests', async ({ page, context }) => {
    // Delay API responses
