...
async function main() {
    console.log("Starting NexusQuant (ELIZAOS CEX/DEX Agent)...");

    // Load character
    const characterPath = path.join(__dirname, "../trader.character.json");
    ...
    console.log("NexusQuant initialized. Ready for low-latency execution.");
}
